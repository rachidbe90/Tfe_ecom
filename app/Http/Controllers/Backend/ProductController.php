    ...
    public function addProductAttribute(Request $request, $id){
        ...
        foreach($data['stock'] as $key=>$val){
            ...
            if(!empty($val)){
                ...
                ProductAttribute::where('product_id',$id)->where('size',$data['size'])->increment('stock',$data['stock'][$key]);
                $attribute['product_id']=$id;
                $attribute['size']=$data['size'];
                if ( !(ProductAttribute::where('product_id',$id)->where('size',$data['size'])->exists()) ) {
                    $attribute->save();
                }
