                        ...
                        <div class="col-lg-7 mb-6 mx-auto">
                            <div class="wao-fro">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <label>Email *</label>
                                        <input required placeholder="Enter your email address" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}"  />
                                ...
                                <button type="submit" class="btn btn-success btn-order mt-2">Submit</button>
