                            ...
                            <div class="row">
                                <div class="col-12 col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="firstName" name="first_name" value="{{$user->first_name}}" placeholder="eg. Dupont">
                                        @error('first_name')
                                ...
                                <div class="col-12 col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="lastName" name="last_name" value="{{$user->last_name}}" placeholder="eg. jean">
                                        @error('first_name')
                                        <p class="text-danger">{{$message}}</p>
                                        @enderror
                                    </div>
