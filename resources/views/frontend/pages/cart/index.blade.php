...
@section('scripts')
    <script>  {{-- Add coupon --}}
        $(document).on('click','.coupon-btn',function (e) {
            ...
            $('.coupon-btn').html('Applying...');
            $('#coupon-form').submit();
        });
    </script>

    <script> {{-- delete item in cart --}}
    ...
    <script> {{-- Add quantity item --}}
        $(document).on('click','.qty-text',function () {
            ...
            var productSize=$("#update-cart-size-"+id).data('product-size');
            var productID=$("#update-cart-product_id-"+id).data('product_id');
            update_cart(id,productQuantity,productSize,productID)
        });
        function update_cart(id,productQuantity,productSize,productID) {
            var rowId=id;
