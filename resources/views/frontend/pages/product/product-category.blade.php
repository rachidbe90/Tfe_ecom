                                ...
                                <div class="row">
                                    <div class="col-lg-7 d-flex align-items-center">
                                        <div class="product-title">
                                            <h5>{{$category->title}} <small>(Showing {{$products->total()}} products)</small> </h5>
                                        </div>
                                    </div>
                                    <div class="col-lg-5 d-flex justify-content-end">
                                        <div class="product-sort">
                                            <div class="form-inline">
                                                ...
                                                <select id="sortBy" class="custom-select small right">
...
@section('scripts')
    ...
    <script> {{-- change sortby --}}
        $('#sortBy').change(function () {
            var sort=$('#sortBy').val();
            window.location="{{url(''.$route.'')}}/{{$category->slug}}?sortBy="+sort;
        });
    </script>

    {{--    Price slider--}}

    <script> {{-- change price range --}}
        function filter(){
