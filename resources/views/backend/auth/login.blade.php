...
<head>
    ...
    <meta name="author" content="Ahggoune">
    ...
    <style>
        body{
            background: url(/backend/assets/images/auth_bg1.jpg) rgba(239, 193, 92, 0.45);
    ...
    <div class="vertical-align-wrap" >
        <div class="vertical-align-middle auth-main">
            <div class="auth-box">
                ...
                <div class="card" style="background: #FFCF4F">

                    <div class="header">
                        <p class="lead text-center">Login to your admin account</p>
                    </div>
                    <div class="top text-center">
                        <img src="{{asset(get_setting('logo'))}}" alt="AyaMarket">
                    </div>
                    <div class="body">
                        @if($errors->any())
                        ...
                        <form class="form-auth-small" method="POST" action="{{ route('admin.login') }}">
                            ...
                            <button type="submit" class="btn btn-primary btn-lg btn-block" style="background: #1d6586">LOGIN</button>
                        </form>
                    </div>
                </div>
            </div>
