                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a> Categories
                            <a class="btn btn-sm btn-outline-secondary" href="{{route('category.create')}}"><i class="icon-plus"></i> Create Category</a></h2>
                                ...
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                    ...
                                    @foreach($categories as $item)
                                        <tr>
                                            ...
                                            <td>{{$item->title}}</td>
                                            <td><img src="{{asset($item->photo)}}" alt="category image" style="max-height: 90px; max-width: 120px"></td>
