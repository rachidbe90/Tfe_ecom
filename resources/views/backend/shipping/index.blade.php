            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a> Shipping
                            <a class="btn btn-sm btn-outline-secondary" href="{{route('shipping.create')}}"><i class="icon-plus"></i> Create Shipping</a></h2>
...
{{--                section list--}}
                <div class="col-lg-12">
                    <div class="card">
                        <div class="header">
                            <h2><strong>Shippings</strong> List</h2>
                        </div>
                        <div class="body">
                                ...
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                    ...
                                    @foreach($shippings as $item)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{route('shipping.edit',$item->id)}}" data-toggle="tooltip" title="edit" class="float-left btn btn-sm btn-outline-warning" data-placement="bottom"><i class="fas fa-edit"></i> </a>
