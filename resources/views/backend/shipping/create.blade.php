                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-12 col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Deliver Time" name="delivery_time" value="{{old('delivery_time')}}">
                                        </div>
                                    </div>
                                    <div class="col-lg-12 col-md-12">
                                        <div class="form-group">
                                            <label for="">Delivery Charge</label>
                                            <input type="number" step="any" class="form-control" placeholder="Deliver Charge" name="delivery_charge" value="{{old('delivery_charge')}}">
                                        </div>
                                    </div>
