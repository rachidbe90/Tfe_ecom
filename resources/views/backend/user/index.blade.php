...
{{--                                    Affichier les information dans le tableau Users--}}
...
{{--                                                        La vue d'user--}}
                                                        ...
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" text-center id="exampleModalLongTitle">{{$item->first_name}} {{$item->last_name}}</h5>
