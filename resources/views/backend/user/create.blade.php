                            ...
                            <form action="{{route('user.store')}}" method="post">
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-12 col-md-12">
                                        <div class="form-group">
                                            <label for="">Num</label>
                                            <input type="number" class="form-control" placeholder="Num" name="num" value="{{old('num')}}">
                                        </div>
                                    </div>
                                    <div class="col-lg-12 col-md-12">
                                        <div class="form-group">
                                            <label for="">Postcode</label>
                                            <input type="number" class="form-control" placeholder="Postcode" name="postcode" value="{{old('postcode')}}">
                                        </div>
                                    </div>
                                    <div class="col-lg-12 col-md-12">
                                        <div class="form-group">
